######################################################################
# Author: Emily Lovell          ****** TODO: CHANGE THIS!! ******
# username: lovelle             ****** TODO: CHANGE THIS!! *****
#
# Purpose: Compute the total chocolate desired by the user
#
######################################################################
# Acknowledgements:
#
# Modified from original code written by Dr. Jan Pearce & Dr. Scott Heggen
#
